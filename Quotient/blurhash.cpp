...
namespace Quotient
{
DecodedImage decode_blurhash(std::string_view blurhash, size_t width, size_t height, size_t bytesPerPixel) noexcept
{
    DecodedImage i{};
...
std::string encode_blurhash(unsigned char *image, size_t width, size_t height, int components_x, int components_y)
{
