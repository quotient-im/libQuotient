...
::
  ...
  quotient_generate_headers(<camelcase_forwarding_headers_var>
...
CamelCase forwarding files, but quotient_generate_headers() uses it when checking
...
function(QUOTIENT_GENERATE_HEADERS camelcase_forwarding_headers_var)
    set(options)
    ...
    if (EGH_UNPARSED_ARGUMENTS)
        message(FATAL_ERROR "Unexpected arguments to QUOTIENT_GENERATE_HEADERS: ${EGH_UNPARSED_ARGUMENTS}")
    endif()

    if(NOT EGH_HEADER_NAMES)
       message(FATAL_ERROR "Missing header_names argument to QUOTIENT_GENERATE_HEADERS")
    endif()
    ...
    if(NOT EGH_ORIGINAL STREQUAL "LOWERCASE" AND NOT EGH_ORIGINAL STREQUAL "CAMELCASE")
        message(FATAL_ERROR "Unexpected value for original argument to QUOTIENT_GENERATE_HEADERS: ${EGH_ORIGINAL}")
    endif()
